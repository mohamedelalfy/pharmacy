...
?>
    <div class="container login-page">
        <h1 class="text-center">
            ...
            <span  data-class="signup">Register</span>
        </h1>
        <!-- Start Login Form -->
        ...
        <form class="signup" action="<?php echo $_SERVER['PHP_SELF'] ?>"  method="POST">
            <div class="input-container">
                <input  pattern=".{4,}"  title="Username Must Be Larger Than 4 Chars" class="form-control" type="text" name="username" autocomplete="off" placeholder="Type Your Username" required />
            </div>
            <div class="input-container">
        ...
        <?php
            if(!empty($formErrors)){
                ...
                foreach($formErrors as $error){
                    ...
                    echo "<P class='msg'><i class='fa fa-times'></i>" .$error . "</p>";
                }
                if(isset($success)){

                    echo "<div class='msg susccess'>" .$success . "</div>";
                }
            }
        ?>
